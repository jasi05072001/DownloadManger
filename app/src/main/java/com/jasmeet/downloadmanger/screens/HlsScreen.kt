...
import com.jasmeet.downloadmanger.mediaItemList.HlsMediaItemList
...
fun HlsScreen( modifier: Modifier=Modifier,navController: NavHostController) {
    ...
    val firstMediaItem = HlsMediaItemList.firstMediaItem
    val secondMediaItem = HlsMediaItemList.secondMediaItem
    val thirdMediaItem = HlsMediaItemList.thirdMediaItem
...
//                                .build()
                            ...
                            if (!downloadUtil
                                    .hasDownload(secondMediaItem.localConfiguration?.uri)
                            ) {
                                downloadUtil
                                    .toggleDownloadDialogHelper(context, secondMediaItem, videoId = "null")
                            }
                        }
                    } catch (e: Exception) {
                        Toast.makeText(context, e.message.toString(), Toast.LENGTH_SHORT).show()
